...
url = "http://localhost:5001/matrices/determinant"  # Définit l’adresse de la route Flask à tester

data = {  # Crée les données qui seront envoyées à l’API
    "A": [[1, 2], [3, 4]]  # Définit la matrice A dont on veut calculer le déterminant
