...
url = "http://localhost:5001/matrices/multiply"  # Définit l’adresse de la route Flask à tester

data = {  # Crée les données qui seront envoyées à l’API
    "A": [[1, 2], [3, 4]],  # Définit la première matrice appelée A
    "B": [[5, 6], [7, 8]]  # Définit la deuxième matrice appelée B
}  # Fin du dictionnaire contenant les matrices
